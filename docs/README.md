...
| Understand runtime transport behavior and errors | [`transport.md`](transport.md) |
...
| Review this session's delivered work and next targets | [`session-review-2026-08-01.md`](session-review-2026-08-01.md) |
